...
3. Откройте CSV-файл в Excel или другой табличной программе.
4. Используйте колонку **Готовое сообщение** для отправки пользователям.

В таблице есть фамилия, имя, логин, статус, отдел, профиль доступа, connect-ссылка и готовое сообщение для каждого пользователя.
