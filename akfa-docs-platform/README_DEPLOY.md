...
Файлы приложений лежат отдельно:

```text
/opt/akfa-downloads/Happ.apk
/opt/akfa-downloads/Happ.macOS.universal.dmg
/opt/akfa-downloads/FlClashX-windows-amd64-setup.exe
/opt/akfa-downloads/FlClashX-macos-arm64.dmg
```

Nginx отдаёт их по `/downloads/`. Приложение не хранит и не управляет этими файлами.
