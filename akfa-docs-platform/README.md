...
Стартовые установщики описаны в `seed-downloads/downloads.manifest.json`.
Публичные ссылки стабильные:
...
Production install копирует seed-файлы в `/opt/akfa-downloads/`.
После установки админ может заменить файл в разделе **Файлы / Загрузки** без изменения public URL.
